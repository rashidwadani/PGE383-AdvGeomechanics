...
NotebookDataLength[     10725,        228]
NotebookOptionsPosition[     11132,        219]
NotebookOutlinePosition[     11730,        243]
CellTagsIndexPosition[     11687,        240]
WindowFrame->Normal*)
...
Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`\[Sigma]11$$ = -0.18000000000000016`, \
$CellContext`\[Sigma]12$$ = -1.48, $CellContext`\[Sigma]13$$ = \
-0.29000000000000004`, $CellContext`\[Sigma]22$$ = 
    1.67, $CellContext`\[Sigma]23$$ = -1.01, $CellContext`\[Sigma]33$$ = 
    0.9900000000000002, $CellContext`\[Phi]\[Theta]$$ = {1.335176877775662, 
...
(*NotebookFileOutline
Notebook[{
Cell[1464, 33, 9664, 184, 605, "Output"]
}
]
*)
...
(* NotebookSignature vwppnAsLEb@fuC1Mutn#iQc0 *)
